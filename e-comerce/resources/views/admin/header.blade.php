<nav class="navbar p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
      <a class="navbar-brand brand-logo-mini" href="{{url('admin.home')}}" style="padding: 14px, 20px, 11px, 22px!important;
"><img src="admin/assets/img/logo.png" alt="logo" /></a>
    </div>
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        ...
        <div class="dropdown">
            @if(Auth::check())
            <div class="user-menu" style="padding-left: 236px">
                <div class="dropdown">
